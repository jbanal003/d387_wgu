...
export class AppComponent implements OnInit{
 ...
 //     this.rooms=ROOMS;
    ...
    roomsearchValueChanges$.subscribe(x => {
      ...
      this.getWelcomeMessage().subscribe(messages => {
        this.welcomeMsg = messages;}
      )

      // Loading converted times
      this.getConvertedTimes().subscribe(times => {
  ...
  getConvertedTimes(): Observable<any> {
    return this.httpClient.get(this.baseURL + '/times/timezones', {responseType: 'json'});
  }
